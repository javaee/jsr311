...
public class NewCookie extends Cookie {
    ...
    public NewCookie(String name, String value, String path, String domain, 
            String comment, int maxAge, boolean secure) {
     ...
     */
    public NewCookie(String name, String value, String path, String domain, 
            int version, String comment, int maxAge, boolean secure) {
    ...
    public NewCookie(Cookie cookie) {
        super(cookie.getName(), cookie.getValue(), cookie.getPath(), cookie.getDomain(), 
                cookie.getVersion());
    }
    ...
    public NewCookie(Cookie cookie, String comment, int maxAge, boolean secure) {
        this(cookie.getName(), cookie.getValue(), cookie.getPath(), cookie.getDomain(), 
                cookie.getVersion(), comment, maxAge, secure);
    }
    ...
    public static NewCookie parse(String value) throws IllegalArgumentException {
        try {
            ...
            throw new IllegalArgumentException("Cookie invalid", ex);
        }
    }
