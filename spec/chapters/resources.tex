...
\item Exceptions thrown during construction of parameter values are treated as client errors
\end{itemize}
...
\hline
foo.xml.bar & foo.bar & application/xml & fr \tabularnewline
\hline
foo.en.xml & foo & application/xml & en-US \tabularnewline
\hline
foo.xml.en & foo & application/xml & en-US \tabularnewline
\hline
foo.json.xml & foo & application/xml & fr \tabularnewline
\hline
foo.xml.json & foo & application/json & fr \tabularnewline
\hline
foo.xml.en.json.de & foo & application/json & de \tabularnewline
\hline
foo.xml.en.json.de.bar & foo.bar & application/json & de \tabularnewline
\hline
