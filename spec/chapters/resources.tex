...
\item If $e$ is a member of $M$ then set the value of the \code{Accept} header to \code{config\-.get\-Extension\-Mappings()\-.get($e$)}
\item Else if $e$ is a member of $L$ then set the value of the \code{Accept-Language} header to \code{config\-.get\-Language\-Mappings()\-.get($e$)}
\end{enumerate}
\end{enumerate}
