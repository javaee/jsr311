...
\begin{enumerate}
\item An instance of \rd\ can be instantiated and injected using the static method \rd\code{.setInstance}. In this case the implementation is responsible for creating the instance; this option is intended for use with implementations based on IoC frameworks.
...
If not supplied by injection, the \rd\ implementation class is determined using the following algorithm. The steps listed below 
